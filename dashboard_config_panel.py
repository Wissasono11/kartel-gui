...
class DashboardConfigPanel:
    ...
    def create_config_panel(self):
        ...
        self.add_manual_control_section(config_layout)
    ...
    def add_setpoint_section(self, layout):
        ...
        layout.addWidget(QLabel("Target Kelembaban(%)"))
        self.parent.kelembaban_input = QLineEdit(str(target_data["humidity"]))
        self.parent.kelembaban_input.textChanged.connect(self.parent.event_handlers.validate_humidity_input)
        self.parent.kelembaban_input.textChanged.connect(self.parent.event_handlers.on_manual_setpoint_change)
        layout.addWidget(self.parent.kelembaban_input)
        ...
        if profiles:
            ...
            if success:
                ...
                self.parent.kelembaban_input.setText(str(default_profile["humidity"]))
        ...
        self.parent.input_fields['humidity'] = self.parent.kelembaban_input
    ...
    def add_manual_control_section(self, layout):
        """Add manual control section"""
        layout.addWidget(self.ui_components.create_form_label("Kontrol Manual"))
        
        self.parent.heater_toggle_btn = QPushButton(" Toggle Pemanas")
        self.parent.heater_toggle_btn.setIcon(QIcon(self.ui_components.load_svg_icon("pemanas-control.svg", QSize(20, 20))))
        self.parent.heater_toggle_btn.setObjectName("heaterButton")
        self.parent.heater_toggle_btn.clicked.connect(lambda: self.parent.event_handlers.toggle_device("pemanas"))
        layout.addWidget(self.parent.heater_toggle_btn)
        
        self.parent.humidifier_toggle_btn = QPushButton(" Toggle Humidifier")
        self.parent.humidifier_toggle_btn.setIcon(QIcon(self.ui_components.load_svg_icon("humidifier-control.svg", QSize(20, 20))))
        self.parent.humidifier_toggle_btn.setObjectName("humidifierButton")
        self.parent.humidifier_toggle_btn.clicked.connect(lambda: self.parent.event_handlers.toggle_device("humidifier"))
        layout.addWidget(self.parent.humidifier_toggle_btn)
